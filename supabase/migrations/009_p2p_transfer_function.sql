-- Updated P2P Transfer Function matching the custom schema
...
BEGIN
    ...
    -- Log transaction using the user's exact table structure
    -- type: transfer, method: vault, status: completed
