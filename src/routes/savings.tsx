              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <Card className="rounded-[2rem] border border-white/30 bg-white/70 dark:bg-slate-950/70 backdrop-blur-2xl overflow-hidden flex flex-col shadow-xl">
                  <CardHeader>
                    ...
                    <CardTitle className="font-black text-slate-950 dark:text-white uppercase tracking-tight">
                      Vault Wisdom
                    </CardTitle>
                  </CardHeader>
                  ...
                  <div className="p-8 mt-auto border-t border-white/20">
                    <Button
                      variant="outline"
                      className="w-full rounded-xl border-primary/30 font-black hover:bg-primary/5 transition-all"
                      onClick={nextJoke}
                    >
                      Another Tip
                    </Button>
                  ...
                  <table className="w-full text-left">
                    <thead>
                      <tr className="border-b border-white/20 bg-primary/5">
                        <th className="px-6 py-4 text-xs font-black uppercase tracking-wider text-slate-950 dark:text-white">
                          Date
                        </th>
                        <th className="px-6 py-4 text-xs font-black uppercase tracking-wider text-slate-950 dark:text-white">
                          Source
                        ...
                        <th className="px-6 py-4 text-xs font-black uppercase tracking-wider text-slate-950 dark:text-white text-right">
                          Running Total
                        </th>
                      </tr>
                    </thead>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                      <div className="space-y-3">
                        <div className="flex items-center justify-between">
                          <Label
                            htmlFor="title"
                            className="text-sm font-black uppercase tracking-[0.1em] text-emerald-700 dark:text-emerald-400"
                          >
                            Goal Title
                          </Label>
                          <span className="text-[10px] text-muted-foreground font-black animate-pulse bg-emerald-500/5 px-2 py-0.5 rounded-full border border-emerald-500/10 shadow-sm">
                            💡 ideas: Tech, Home
                          </span>
                        </div>
                    ...
                    <div className="space-y-3">
                      ...
                      <Select>
                        ...
                        <SelectContent className="rounded-2xl border-white/30 bg-white/90 dark:bg-slate-900/95 backdrop-blur-2xl shadow-2xl max-h-[400px] overflow-y-auto">
                          ...
                          <div className="px-3 py-2 text-[10px] font-black text-muted-foreground uppercase border-t border-white/10 mt-1">
                            Categories
                          </div>
                          <SelectItem value="any_mobile" className="font-black text-primary">
                            Any Mobile Money
                          </SelectItem>
                          <SelectItem value="any_bank" className="font-black text-primary">
                            Any Bank Account
                          </SelectItem>
                          <div className="px-3 py-2 text-[10px] font-black text-muted-foreground uppercase border-t border-white/10 mt-1">
                            Specifics
                ...
                {savingsGoal?.current_amount < savingsGoal?.target_amount ? (
                  <>
                    ...
                    <h2 className="text-5xl font-black text-slate-950 dark:text-white mb-4 tracking-tight drop-shadow-sm">
                      You have a pending saving left
                    </h2>
                    ...
                    <div className="flex flex-col sm:flex-row gap-6 justify-center">
                      <Button
                        size="lg"
                        className="h-18 px-12 rounded-[1.5rem] text-xl font-black shadow-2xl shadow-primary/30 bg-primary hover:bg-primary/90 transition-all"
                    ...
                    <div className="space-y-8">
                      <div className="flex flex-col sm:flex-row gap-6 justify-center">
                        ...
                        <Button
                          variant="outline"
                          size="lg"
                          className="h-18 px-12 rounded-[1.5rem] text-xl font-black border-white/40 backdrop-blur-md transition-all duration-300 hover:bg-white/10"
                          onClick={() => setActiveTab("setup")}
                        >
                          Start New Goal
                        </Button>
        ...
        <DialogContent className="max-w-md rounded-[2.5rem] border-white/30 bg-white/95 dark:bg-slate-950/95 backdrop-blur-3xl p-0 overflow-hidden shadow-2xl">
          <div className="relative p-8">
                ...
                >
                  {["daily", "weekly", "monthly", "yearly"].map((freq) => (
                    ...
                    >
                      ...
                      <Label
                        htmlFor={freq}
                        className="capitalize font-black text-sm cursor-pointer"
                      >
                        {freq}
                      </Label>
                    </div>
            ...
            <div className="mt-10 flex gap-4">
              ...
              <Button
                className="flex-1 h-14 rounded-2xl font-black shadow-xl"
