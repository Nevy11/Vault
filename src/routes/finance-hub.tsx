...
import { ShieldCheck, ArrowRight, TrendingUp, Sparkles, Target, Wallet, History, AlertCircle, Lock as LockIcon, PiggyBank, Landmark } from "lucide-react";
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="text-center z-20">
                    ...
                    <div className="mt-2 flex flex-col items-center">
                      <span className="text-emerald-700 font-black text-[11px] tracking-[0.4em] uppercase">Wealth Vault</span>
                ...
                <div className="space-y-4 flex-1">
                  ...
                  <ul className="space-y-3">
                    {[
                      ...
                      <li key={i} className="flex items-center gap-3 text-xs font-black text-slate-900 dark:text-slate-100">
              ...
              <div className="h-40 w-full bg-emerald-50 relative overflow-hidden">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="text-center z-20">
                    ...
                    <div className="mt-2 flex flex-col items-center">
                      <span className="text-emerald-700 font-black text-[11px] tracking-[0.4em] uppercase">Credit Line</span>
                      <div className="h-0.5 w-12 bg-emerald-500/30 mt-1" />
                    </div>
                  </div>
                </div>
